...
const UploadLicense = () => {
  ...
  return (
    <View style={styles.container}>
      {/* Header */}
      <Header title="Licenses" onBackPress={() => navigation.goBack()} />
      ...
      <View style={styles.licenseCard}>
        {selectedFile ? (
          ...
          <Image source={require('../assets/images/license-sample.png')} style={styles.licenseImage} />
        )}
      </View>
      ...
      <View style={styles.licenseDetails}>
        ...
        <Text style={styles.licenseType}>ACLS License</Text>
        <Text style={styles.licenseCode}>0000123678593</Text>
        <Text style={styles.licenseExpiry}>31/01/2025</Text>
      </View>

        <TouchableOpacity style={styles.continueButton} onPress={() => navigation.navigate('LicenseDetailsUpload')}>
